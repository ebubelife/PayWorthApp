...
import 'package:payworth/screens/onboarding/set_transaction_pin.dart';
...
class SetLoginPin extends StatefulWidget {
  const SetLoginPin({super.key, required this.title});
            ...
            body: Container(
                ...
                child: SingleChildScrollView(
                  ...
                  children: [
                    ...
                    const Center(
                        child: Text(
                            "Create a passcode to log into your account \n safely",
                        ...
                        child: ElevatedButton(
                            onPressed: () {
                              if (pinHolder!.length == 4) {
                                ...
                                Auth()
                                    .setLoginPin(pin: pinHolder)
                                    .then((value) => {
                                          if (value == 201)
                                            {
                                              showToast("Successful!"),
                                              Get.to(const SetTransactionPin(
                                                  title:
                                                      "Payworth - Set transaction pin"))
                                            }
                                          else if (value == 500)
                                            {
                                              showToast(
